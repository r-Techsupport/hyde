...
<button on:click={clickHandler} style="padding-left: {indent}rem">
    {#if children.length > 0}
        ...
        {:else}
            ...
            <svg style="transform: rotate(90deg)" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"><path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z"/></svg>
        {/if}
    {/if}
        {name}
</button>
